 ...
 */
public abstract class Hilt_GenresFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_GenresFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GenresFragment_GeneratedInjector) this.generatedComponent()).injectGenresFragment(UnsafeCasts.<GenresFragment>unsafeCast(this));
    }
  }
