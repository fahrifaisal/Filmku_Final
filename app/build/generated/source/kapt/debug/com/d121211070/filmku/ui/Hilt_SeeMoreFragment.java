 ...
 */
public abstract class Hilt_SeeMoreFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeeMoreFragment() {
    super();
  }

  Hilt_SeeMoreFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeeMoreFragment_GeneratedInjector) this.generatedComponent()).injectSeeMoreFragment(UnsafeCasts.<SeeMoreFragment>unsafeCast(this));
    }
  }
