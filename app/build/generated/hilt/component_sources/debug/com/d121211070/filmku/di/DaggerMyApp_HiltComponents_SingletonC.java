...
import com.d121211070.filmku.MainActivity;
...
import com.d121211070.filmku.ui.DetailsFragment;
import com.d121211070.filmku.ui.GenresFragment;
import com.d121211070.filmku.ui.SearchFragment;
import com.d121211070.filmku.ui.SeeMoreFragment;
import com.d121211070.filmku.ui.TrendingFragment;
import com.d121211070.filmku.ui.viewModel.SharedViewModel;
import com.d121211070.filmku.ui.viewModel.SharedViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private ProductRepository productRepository() {
      return new ProductRepository(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule), singletonCImpl.trendingApiProvider.get(), singletonCImpl.genresApiProvider.get(), singletonCImpl.searchApiProvider.get(), singletonCImpl.topRatedApiProvider.get(), singletonCImpl.upcomingApiProvider.get(), singletonCImpl.popularApiProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.d121211070.filmku.ui.viewModel.SharedViewModel", ((Provider) sharedViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.d121211070.filmku.ui.viewModel.SharedViewModel 
          return (T) new SharedViewModel(viewModelCImpl.productRepository());
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private Provider<TrendingInterface> trendingApiProvider;

    private Provider<GenresInterface> genresApiProvider;

    private Provider<SearchInterface> searchApiProvider;

    private Provider<TopRatedInterface> topRatedApiProvider;

    private Provider<UpcomingInterface> upcomingApiProvider;

    private Provider<PopularInterface> popularApiProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.trendingApiProvider = DoubleCheck.provider(new SwitchingProvider<TrendingInterface>(singletonCImpl, 0));
      this.genresApiProvider = DoubleCheck.provider(new SwitchingProvider<GenresInterface>(singletonCImpl, 1));
      this.searchApiProvider = DoubleCheck.provider(new SwitchingProvider<SearchInterface>(singletonCImpl, 2));
      this.topRatedApiProvider = DoubleCheck.provider(new SwitchingProvider<TopRatedInterface>(singletonCImpl, 3));
      this.upcomingApiProvider = DoubleCheck.provider(new SwitchingProvider<UpcomingInterface>(singletonCImpl, 4));
      this.popularApiProvider = DoubleCheck.provider(new SwitchingProvider<PopularInterface>(singletonCImpl, 5));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.d121211070.filmku.data.apiInterfaces.TrendingInterface 
          return (T) AppModule_TrendingApiFactory.trendingApi();

          case 1: // com.d121211070.filmku.data.apiInterfaces.GenresInterface 
          return (T) AppModule_GenresApiFactory.genresApi();

          case 2: // com.d121211070.filmku.data.apiInterfaces.SearchInterface 
          return (T) AppModule_SearchApiFactory.searchApi();

          case 3: // com.d121211070.filmku.data.apiInterfaces.TopRatedInterface 
          return (T) AppModule_TopRatedApiFactory.topRatedApi();

          case 4: // com.d121211070.filmku.data.apiInterfaces.UpcomingInterface 
          return (T) AppModule_UpcomingApiFactory.upcomingApi();

          case 5: // com.d121211070.filmku.data.apiInterfaces.PopularInterface 
          return (T) AppModule_PopularApiFactory.popularApi();
